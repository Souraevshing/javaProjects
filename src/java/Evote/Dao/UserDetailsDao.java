...
public class UserDetailsDao {
    ...
    ps3=DBConnection.getConnection().prepareStatement("delete from user_details  where aadhar_no=?");
    ps4=DBConnection.getConnection().prepareStatement("select aadhar_no from user_details where user_type='Voter'");
    ps5=DBConnection.getConnection().prepareStatement("select * from user_details where aadhar_no=? and user_type='Voter'");
        }
